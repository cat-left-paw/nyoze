...
この zip には、展開してそのまま起動できる Windows 版 Nyoze が入っています。
Windows 版は 64bit (x64) 専用です。32bit Windows では使えません。

使い方:
1. zip を任意のフォルダへ展開します。
2. 展開したフォルダ内の Nyoze.exe を起動します。
3. 必要ならショートカットを自分で作成してください。
...
アンインストールとデータ:
- zip 版をやめるだけなら、展開したフォルダを削除します。
- 旧 installer 版は Windows の「設定 > アプリ」からアンインストールしてください。
- 設定やバックアップは %APPDATA%\Nyoze\ に残ります。
